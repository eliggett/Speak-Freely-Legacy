...
/* 8 6-bit subkeys for each of 16 rounds, initialized by setkey_sf() */
...
/* perm[16][16][8]:    2K bytes defining perm. */
{
	register int i,j;
...
/* Do one DES cipher round (the num'th) */
